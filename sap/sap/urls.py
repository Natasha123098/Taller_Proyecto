...
from Doctores.views import Nuevo_Doctor, Editar_Doctor, Eliminar_Doctor, Ver_Doctor
from webapp.views import mostrarDoctores

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', mostrarDoctores, name= 'inicio'),
